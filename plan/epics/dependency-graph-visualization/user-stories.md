...
| --- | --- | --- | --- | --- |
| [Implement ReactFlow Graph Foundation](./user-stories/implement-reactflow-graph-foundation/tasks.md) | Set up ReactFlow with Dagre layout, custom node components, edge styling, and canvas controls | Not Started | 4 tasks | None |

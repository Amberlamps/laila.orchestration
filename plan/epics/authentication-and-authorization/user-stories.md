...
| --- | --- | --- | --- | --- |
| [Configure Better Auth with Google OAuth](./user-stories/configure-better-auth-google-oauth/tasks.md) | Install and configure Better Auth with Google OAuth provider, Drizzle adapter, session management, and catch-all API route | Not Started | 4 tasks | None |
| [Implement API Key Authentication](./user-stories/implement-api-key-authentication/tasks.md) | Implement API key generation with `lw_` prefix, SHA-256 hashing, prefix-based lookup, and validation middleware for execution agents | Not Started | 3 tasks | None |

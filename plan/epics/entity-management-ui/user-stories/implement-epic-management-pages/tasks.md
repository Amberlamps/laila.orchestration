...
| --- | --- | --- | --- | --- |
| [Implement Epic Detail Page](./implement-epic-detail-page.md) | Build epic detail page with breadcrumb, status badges, progress cards, dependencies, and stories table | Not Started | frontend-developer | None |
| [Implement Create Edit Epic Modal](./implement-create-edit-epic-modal.md) | Build create/edit epic modal with title, Markdown description, and project context | Not Started | fullstack-developer | Implement Epic Detail Page |
| [Implement Epic Publish Delete Flows](./implement-epic-publish-delete-flows.md) | Build publish (Draft to Ready) and delete flows with validation and confirmation guards | Not Started | fullstack-developer | Implement Epic Detail Page, Implement Create Edit Epic Modal |

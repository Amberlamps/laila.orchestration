...
| ------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------- | --------------------------- | ------- | ------------------------------------- |
| [Implement Project Management Pages](./user-stories/implement-project-management-pages/tasks.md)  | Project list page, create modal, detail page with tabs, settings tab, and publish/delete flows          | In Progress (laila-agent-3) | 5 tasks | None                                  |
| [Implement Epic Management Pages](./user-stories/implement-epic-management-pages/tasks.md)        | Epic detail page, create/edit modal, and publish/delete lifecycle flows                                 | Not Started                 | 3 tasks | Implement Project Management Pages    |
| [Implement User Story Management Pages](./user-stories/implement-story-management-pages/tasks.md) | Story detail page with tabs, tasks sub-tab, attempt history, create/edit modal, and action flows        | Not Started                 | 5 tasks | Implement Epic Management Pages       |

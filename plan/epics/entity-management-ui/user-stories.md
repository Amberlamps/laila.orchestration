...
| --- | --- | --- | --- | --- |
| [Implement Project Management Pages](./user-stories/implement-project-management-pages/tasks.md) | Project list page, create modal, detail page with tabs, settings tab, and publish/delete flows | Not Started | 5 tasks | None |

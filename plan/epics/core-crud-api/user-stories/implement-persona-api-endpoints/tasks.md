...
| ------------------------------------------------------------------- | ----------------------------------------------------------------------- | ----------- | ----------------- | ----------------------------- |
| [Implement Persona CRUD Routes](./implement-persona-crud-routes.md) | POST/GET/GET:id/PATCH/DELETE endpoints for personas with deletion guard | Not Started | backend-developer | None                          |
| [Write Persona API Tests](./write-persona-api-tests.md)             | Integration tests including deletion guard verification                 | Not Started | qa-expert         | Implement Persona CRUD Routes |

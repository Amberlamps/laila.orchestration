...
| --------------------------------------------------------------------------------- | ---------------------------------------------------------------------- | -------- | ----------------- | ---------------------------------------------------------------- |
| [Implement Epic CRUD Routes](./implement-epic-crud-routes.md)                     | POST/GET/GET:id/PATCH/DELETE endpoints for epics nested under projects | Complete | backend-developer | None                                                             |
| [Implement Epic Lifecycle Transitions](./implement-epic-lifecycle-transitions.md) | Publish (Draft to Ready) transition for epics                          | Complete | backend-developer | Implement Epic CRUD Routes                                       |
| [Write Epic API Tests](./write-epic-api-tests.md)                                 | Integration tests for all epic CRUD and lifecycle operations           | Complete | qa-expert         | Implement Epic CRUD Routes, Implement Epic Lifecycle Transitions |

...
| --------------------------------------------------------------------- | --------------------------------------------------------------------- | -------- | -------------- | ------------ |
| [Implement Shallow Health Check](./implement-shallow-health-check.md) | GET /api/v1/health returning basic service status                     | Complete | sre-engineer   | None         |
| [Implement Deep Readiness Check](./implement-deep-readiness-check.md) | GET /api/v1/health/ready with dependency checks for DB, DynamoDB, SQS | Complete | sre-engineer   | None         |

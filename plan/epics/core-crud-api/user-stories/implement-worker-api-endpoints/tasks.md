...
| --- | --- | --- | --- | --- |
| [Implement Worker CRUD Routes](./implement-worker-crud-routes.md) | POST/GET/GET:id/PATCH/DELETE endpoints for workers with API key generation and deletion guards | Not Started | security-engineer | None |
| [Implement Worker Project Access Routes](./implement-worker-project-access-routes.md) | POST/DELETE endpoints for managing worker project access | Not Started | backend-developer | Implement Worker CRUD Routes |
| [Write Worker API Tests](./write-worker-api-tests.md) | Integration tests for worker CRUD, API key reveal, deletion guards, and project access | Not Started | qa-expert | Implement Worker CRUD Routes, Implement Worker Project Access Routes |

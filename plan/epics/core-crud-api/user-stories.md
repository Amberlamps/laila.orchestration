...
| [Implement User Story API Endpoints](./user-stories/implement-story-api-endpoints/tasks.md)      | CRUD, lifecycle transitions, and read-only enforcement for user stories                  | In Progress (laila-agent-2) | 3 tasks | Implement Error Handling Framework                                     |
...
| [Implement Worker API Endpoints](./user-stories/implement-worker-api-endpoints/tasks.md)         | CRUD for workers with API key generation and project access management                   | In Progress (laila-agent-3) | 3 tasks | Implement Error Handling Framework                                     |

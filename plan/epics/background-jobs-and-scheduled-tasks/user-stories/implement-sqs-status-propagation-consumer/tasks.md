...
| --- | --- | --- | --- | --- |
| [Create Status Propagation Handler](./create-status-propagation-handler.md) | SQS-triggered Lambda handler for cascading status re-evaluation | Not Started | backend-developer | None |
| [Configure SQS Consumer Build](./configure-sqs-consumer-build.md) | tsup build configuration with SQS event types, DLQ, and retry settings | Not Started | backend-developer | Create Status Propagation Handler |
| [Write Status Propagation Tests](./write-status-propagation-tests.md) | Unit tests for cascading unblock, batch processing, idempotency, and DLQ behavior | Not Started | qa-expert | Create Status Propagation Handler |

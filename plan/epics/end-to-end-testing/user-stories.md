...
| [Implement Entity Management E2E Tests](./user-stories/implement-entity-management-e2e-tests/tasks.md)                | E2E tests for worker creation with API key reveal, project access management, persona CRUD with deletion guards, and audit log verification                               | In Progress (laila-agent-2) | 4 tasks | Set Up Playwright Infrastructure |

...
| [Implement Authentication E2E Tests](./user-stories/implement-authentication-e2e-tests/tasks.md)                      | E2E tests for Google OAuth sign-in, session persistence, sign-out, and first-time user onboarding empty states                                                            | In Progress (laila-agent-2) | 3 tasks | Set Up Playwright Infrastructure |

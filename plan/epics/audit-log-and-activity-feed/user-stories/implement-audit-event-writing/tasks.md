...
| --- | --- | --- | --- | --- |
| [Create Audit Event Service](./create-audit-event-service.md) | Service that writes structured audit events to DynamoDB with proper schema, indexing, and error handling | Not Started | backend-developer | None |
| [Integrate Audit Logging in API Mutations](./integrate-audit-logging-in-api-mutations.md) | Add audit event writes to all CRUD API mutations across all entity types | Not Started | backend-developer | Create Audit Event Service |
| [Implement System-Initiated Event Logging](./implement-system-initiated-event-logging.md) | Log system-initiated events: auto-status propagation, timeout reclamation, project auto-complete | Not Started | backend-developer | Create Audit Event Service |

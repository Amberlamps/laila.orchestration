...
| [Define PostgreSQL Schema](./user-stories/define-postgresql-schema/tasks.md)          | Define all Drizzle table schemas: auth, projects, epics, stories, tasks, dependencies, workers, personas, attempt history | In Progress (laila-agent-1) | 8 tasks | Configure Drizzle ORM with Neon |
...
| [Create Seed Scripts](./user-stories/create-seed-scripts/tasks.md)                    | Create development and testing seed profiles with realistic sample data                                                   | Not Started                 | 2 tasks | Implement Repository Layer      |

...
| [Set Up API Client Layer](./user-stories/setup-api-client-layer/tasks.md)                           | Configure openapi-fetch client, create TanStack Query hooks factory, and implement query key factory for cache invalidation                                                 | Complete | 3 tasks | Configure Tailwind CSS & shadcn/ui                                           |

...
| --- | --- | --- | --- | --- |
| [Configure Tailwind CSS & shadcn/ui](./user-stories/configure-tailwind-and-shadcn/tasks.md) | Configure Tailwind CSS v4 with tokenized design theme, install and customize shadcn/ui components, set up fonts and typography, and configure TanStack Query provider | Not Started | 4 tasks | None |

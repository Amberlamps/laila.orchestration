...
| [Configure Production Environment](./user-stories/configure-production-environment/tasks.md) | Production infrastructure using all modules: Lambda functions, DynamoDB, SQS, EventBridge, S3, domain/SSL | In Progress (laila-agent-3) | 4 tasks | Create Terraform Modules                                   |

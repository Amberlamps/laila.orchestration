...
| [Implement Project Overview Tab](./user-stories/implement-project-overview-tab/tasks.md)       | Project detail overview tab with summary stat cards, active workers card, throughput and completion charts, cost tracking, progress indicator, and activity feed | Not Started                 | 7 tasks | None                                                       |

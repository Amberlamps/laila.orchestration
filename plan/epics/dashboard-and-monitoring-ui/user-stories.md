...
| --- | --- | --- | --- | --- |
| [Implement Global Dashboard](./user-stories/implement-global-dashboard/tasks.md) | Cross-project KPI stat cards, project card grid, recent activity snapshot, active workers table, and empty state for the main dashboard page | Not Started | 5 tasks | None |

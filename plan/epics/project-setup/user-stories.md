...
| [Configure CI Pipeline](./user-stories/configure-ci-pipeline/tasks.md)                         | Set up GitHub Actions CI workflow, PR templates, and branch protection rules                     | In Progress (laila-agent-1) | 3 tasks | None                                                                                   |

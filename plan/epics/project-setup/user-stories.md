...
| --- | --- | --- | --- | --- |
| [Initialize pnpm Monorepo Workspace](./user-stories/initialize-pnpm-monorepo/tasks.md) | Set up root workspace configuration, TypeScript, linting, formatting, and git hooks | Not Started | 5 tasks | None |

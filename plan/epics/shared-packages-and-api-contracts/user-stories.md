...
| [Create OpenAPI Specification](./user-stories/create-openapi-specification/tasks.md)                  | Write the OpenAPI 3.1 spec, configure type generation, Spectral linting, and freshness checks         | Complete | 4 tasks | Implement @laila/shared Zod Schemas and Types |

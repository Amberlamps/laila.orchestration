...
| [Create OpenAPI Specification](./user-stories/create-openapi-specification/tasks.md)                  | Write the OpenAPI 3.1 spec, configure type generation, Spectral linting, and freshness checks         | In Progress (laila-agent-1) | 4 tasks | Implement @laila/shared Zod Schemas and Types |

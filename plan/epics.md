...
| [2. Shared Packages & API Contracts](./epics/shared-packages-and-api-contracts/user-stories.md)      | Implement @laila/shared Zod schemas, types, constants, and contract-first OpenAPI specification                                            | In Progress (laila-agent-1) | 2 stories    | Epic 1                     |
...
| [5. Domain Logic Engine](./epics/domain-logic-engine/user-stories.md)                                | Pure domain logic: DAG operations, status transition engine, work assignment engine (no DB dependency)                                     | Not Started                 | 3 stories    | Epic 2                     |

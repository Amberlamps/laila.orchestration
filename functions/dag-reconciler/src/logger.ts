/**
 * Structured logging for the dag-reconciler Lambda function.
 *
...
/**
 * Base pino logger for the dag-reconciler function.
 *
 * Configured with:
...
/**
 * Minimal logger interface for dependency injection into reconciliation
